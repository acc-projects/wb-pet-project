...
class FetchSalesCommand extends Command
{
    ...
    protected $description = 'Fetch and save sales from WB API';

    public function handle(): void
    {
        $this->info('Starting sales fetch...');

        $service = WbApiServiceFactory::createForSales();
        ...
        $this->info("Successfully saved {$savedCount} sales!");
    }
}
